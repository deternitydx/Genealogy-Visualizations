...
foreach ($arr as $i => $mar) {
    ...
    if (($i < count($arr) - 1 && $mar["HusbandID"] === $arr[$i+1]["HusbandID"] && $arr[$i+1]["MarriageDate"] != ""
            && $arr[$i+1]["MarriageDate"] < "1846-03-01" && $mar["WifeDeath"] != ""
            ...
            && $mar["MarriageDate"] < "1846-03-01" && $arr[$i-1]["WifeDeath"] != "" 
...
echo "<h1>Men with multiple marriages before Mar 1, 1846</h1>";
